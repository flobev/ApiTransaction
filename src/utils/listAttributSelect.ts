export type listeTables = "carte" | "creer" | "enfant" | "facture" | "musique" | "stripe" | "tuteur" | "utilisateur";
...
const listAttributSelect: Record < listeTables, attributSelectInterface > = { //Constructs a type with a set of properties Keys of type Type. This utility can be used to map the properties of a type to another type.
    "utilisateur": {
        ...
        attribut: [`id_utilisateur`, `nom`, `prenom`, `email`, `mdp`, `sexe`, `date_naissance`, `role`, `creation`, `modification`, `abonnement`]
    },
    "enfant": {
    ...
    "musique": {
        ...
        attribut: [`nom`, `lien`, `couverture`, `temps`, `creation`, `modification`, `type`, `personne_idpersonne`]
    },
    "carte": {
        primaryKey: `id_carte`,
        attribut: [`numero_carte`, `mois`, `annee`, `defaut`, `personne_idpersonne`]
    },
    "stripe": {
    ...
    "facture": {
        ...
        attribut: [`date_facture`, `montant_ht`, `montant_ttc`, `source`, `creation`, `ville`, `modification`, `id_stripe`]
    },
};
